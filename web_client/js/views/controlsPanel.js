girder.views.SlicerControlsPanel = girder.views.SlicerPanel.extend({
    ...
    render: function () {
        this.$el.html(girder.templates.slicerControlsPanel({
            title: this.title,
    ...
    addOne: function (model) {
        var view = new girder.views.SlicerControlWidget({
            model: model,
            parentView: this
        });
